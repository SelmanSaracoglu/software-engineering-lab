...
// Number(...) tries to convert a value
// into a number.
...
// into a valid number, the result is NaN.
//
// NaN means:
//
// Not a Number
...
// Number.isInteger(...) checks whether
// a value is a whole number.

console.log(Number.isInteger(101));
// true
